        ...
        {!isProjectView && (
          <footer className="flex-shrink-0 px-4 md:px-8 py-3 md:py-4 border-t border-[var(--border-color)] flex flex-col sm:flex-row items-center justify-between gap-2" style={{ background: 'var(--bg-secondary)' }}>
            ...
            <div className="flex gap-3 md:gap-4">
              <a href="https://www.sketchario.app/legal/termini-e-condizioni.html" target="_blank" rel="noopener" className="text-[10px] md:text-[11px] text-[var(--text-muted)] hover:text-white transition-colors">Termini</a>
              <a href="https://www.sketchario.app/legal/privacy-policy.html" target="_blank" rel="noopener" className="text-[10px] md:text-[11px] text-[var(--text-muted)] hover:text-white transition-colors">Privacy</a>
              <a href="https://www.sketchario.app/legal/cookie-policy.html" target="_blank" rel="noopener" className="text-[10px] md:text-[11px] text-[var(--text-muted)] hover:text-white transition-colors">Cookie</a>
            </div>
          </footer>
        )}
      </main>
